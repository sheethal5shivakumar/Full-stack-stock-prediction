...
const API_KEY = '627227b0-1216-48b6-bdf9-14edb0c428cb';
...
export async function fetchLatestQuotes(symbols: string[] = ['BTC', 'ETH', 'XRP', 'BNB', 'SOL']): Promise<Record<string, CryptoData>> {
  try {
    ...
    // Here we'll simulate it with a direct call (which would fail due to CORS)
    
    // NOTE: In production, you should create a Next.js API route to proxy this request
